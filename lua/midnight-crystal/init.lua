...
M.palette = {
	...
	-- ========================================================================
	variable_blue = "#6F8DFF", -- Variables, identifiers, local vars (light blue)
...
function M.load()
	...
	local highlights = {
		...
		-- LSP SEMANTIC TOKENS
		-- ========================================================================
		-- These take precedence over Treesitter, so we set explicit colors

		-- Core types
		["@lsp.type.namespace"] = { fg = p.type_teal },
		["@lsp.type.type"] = { fg = p.type_teal },
		["@lsp.type.class"] = { fg = p.type_teal },
		["@lsp.type.enum"] = { fg = p.type_teal },
		...
		["@lsp.type.modifier"] = { fg = p.purple_dark },
		["@lsp.type.comment"] = { fg = p.foreground_soft, italic = true },
		["@lsp.type.string"] = { fg = p.info_cyan },
		["@lsp.type.number"] = { fg = p.warning_yellow },
		["@lsp.type.regexp"] = { fg = p.warning_yellow },
		["@lsp.type.operator"] = { fg = p.accent_primary },
		["@lsp.type.decorator"] = { fg = p.hint_purple },
		["@lsp.type.builtinType"] = { fg = p.type_teal, bold = true },

		-- Type modifiers (these combine with base types)
		["@lsp.typemod.variable.readonly"] = { fg = p.warning_yellow },
		["@lsp.typemod.variable.defaultLibrary"] = { fg = p.warning_yellow },
		["@lsp.typemod.variable.global"] = { fg = p.variable_blue, bold = true },
		["@lsp.typemod.function.defaultLibrary"] = { fg = p.foreground_dim, bold = true },
		["@lsp.typemod.method.defaultLibrary"] = { fg = p.foreground_dim, bold = true },
		["@lsp.typemod.class.defaultLibrary"] = { fg = p.type_teal, bold = true },
		["@lsp.typemod.type.defaultLibrary"] = { fg = p.type_teal, bold = true },
